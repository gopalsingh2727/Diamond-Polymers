...
import { mockOrders, mockEfficiencyTrends, mockProductionOutput } from "../../lib/mockData";
import { LineChart, Line, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, PieChart, Pie, Cell } from "recharts";
import { useState, useRef } from "react";
import { DateRangeFilter, DateRange } from "../DateRangeFilter";
import { filterOrdersByDateRange, getDefaultDateRange, isDateInRange } from "../../lib/dateUtils";
...
export function OverviewReport() {
  ...
  // Filter efficiency trends by date range
  const filteredEfficiencyTrends = mockEfficiencyTrends.filter(item => 
    isDateInRange(item.date, dateRange)
  );

  // Filter production output by date range
  const filteredProductionOutput = mockProductionOutput.filter(item => 
    isDateInRange(item.date, dateRange)
  );
