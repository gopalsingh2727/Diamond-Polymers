...
export const FloatingInput = ({
  ...
  <div className="relative z-0 w-full mb-5 group">
    <input
      ...
      name={name}
      id={name}
      className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#FF6B35] peer"
      placeholder=" "
      required={required}
    />
    <label
