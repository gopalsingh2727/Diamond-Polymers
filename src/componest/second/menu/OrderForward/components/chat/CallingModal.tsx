...
const CallingModal: React.FC<CallingModalProps> = ({
  ...
  if (isMinimized) {
    return (
      <div className="call-minimized-bar calling">
        <div className="minimized-info">
          ...
          <div className="minimized-text">
            ...
            <span className="minimized-status">Calling...</span>
          </div>
        </div>
        <div className="minimized-actions">
          ...
          <button className="minimized-btn end" onClick={handleCancel} title="End call">
  ...
  return (
    <div className="call-modal-overlay">
      <div className="call-modal calling-modal enhanced">
        {/* Minimize Button */}
        {onMinimize && (
          <button className="call-minimize-btn" onClick={onMinimize} title="Minimize">
        ...
        <div className="call-modal-header">
          ...
          <div className="call-type-badge">
            {callType === 'video' ? (
              <>
                <VideocamIcon width={16} height={16} />
        ...
        <div className="call-actions enhanced">
          <button className="call-btn-enhanced cancel-btn" onClick={handleCancel} title="Cancel call">
            <div className="btn-circle cancel">
              <CallEndIcon width={28} height={28} />
            </div>
