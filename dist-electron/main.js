...
app.whenReady().then(() => {
  ...
  mainExports$1.autoUpdater.on("update-available", (info) => {
    win2 == null ? void 0 : win2.webContents.send("update-can-available", info);
  });
  mainExports$1.autoUpdater.on("download-progress", (progress) => {
    win2 == null ? void 0 : win2.webContents.send("download-progress", progress);
  });
  mainExports$1.autoUpdater.on("update-downloaded", () => {
    win2 == null ? void 0 : win2.webContents.send("update-downloaded");
  });
  mainExports$1.autoUpdater.on("error", (err) => {
    win2 == null ? void 0 : win2.webContents.send("update-error", { message: err.message });
  });
});
